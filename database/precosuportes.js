...
const precosuportes = connection.define("preçosuporte",{ //perguntas é o nome da tabela.
    Tipo:{ // nome da coluna
    ...
    Preço:{ // nome da coluna
        type: sequelize.FLOAT,//Obs: .Text serve para textos mais longos.
        allowNull:false
...
precosuportes.sync({force: false}).then(() => {}); //observe que o comando "force:false" serve para criar a tabela apenas uma vez.

module.exports = precosuportes;